...
import com.graphview.series.Series;
...
public class LegendRenderer {
     ...
     *
     * @param graphView regarding com.graphview
     */
    ...
    protected List<Series> getAllSeries() {
        ...
        allSeries.addAll((Collection<? extends Series>) mGraphView.getSeries());
        if (mGraphView.mSecondScale != null) {
            allSeries.addAll((Collection<? extends Series>) mGraphView.getSecondScale().getSeries());
        }
        return allSeries;
    }
     ...
     *          to the corner of the com.graphview
     */
